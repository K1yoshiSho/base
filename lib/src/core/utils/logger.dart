...
// typedef LogFormatter = String Function(LogMessage message, 
//LogOptions options);
...
//   /// Set up the logger
//   L runLogging<L>(L Function() fn, [LogOptions options = 
//const LogOptions()]);
...
//   String formatTime() =>
//       [hour, minute, second].map((i) => 
//i.toString().padLeft(2, '0')).join(':');
// }
